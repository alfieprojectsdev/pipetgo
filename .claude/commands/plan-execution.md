...
**Generic Agents (portfolio-wide):**
- **@agent-architect**: Designs features, writes ADRs, makes architecture decisions
...
CRITICAL: Use the exact @agent-[name] or @pipetgo-[name] format to trigger delegation.
