...
**Architecture & Design:**
- **@agent-architect**: Analyzes code, designs solutions, writes ADRs (NEVER implements - architecture only)
...
- **@agent-debugger**: Investigates errors through systematic evidence gathering (temporary debug changes MUST be removed)

**Quality & Security:**
- **@agent-quality-reviewer**: Reviews code for real issues (security, data loss, performance)
- **@agent-security-auth**: Reviews authentication, authorization, and security systems
...
- **@agent-technical-writer**: Creates documentation after feature completion
